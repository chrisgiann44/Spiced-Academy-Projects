...
// requests only coming from our signature (should be after
// body Parser and coockie Session)
            ...
            if (data) {
                ...
                db.findNames()
                    ...
                    .then(() => {
                        ...
                        redis.setex("signers", 150, JSON.stringify(signers));
                        let totalSigners = signers.length;
                        res.render("signers", {
                            layout: "main",
                            signers: signers,
